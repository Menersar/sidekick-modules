...
export default {
  ...
  "fr": {
    ...
    "gui.menuBar.downloadToComputer.cc3": "Sauvegarder le fichier .cc3 sur votre ordinateur",
  ...
  "zh-cn": {
    ...
    "gui.aboutModal.appVersion": "ClipCC 版本",
    "gui.aboutModal.license": "开源协议",
    "gui.aboutModal.licenseContent": "GNU Affero 通用公共许可证第三版",
    ...
    "gui.unsupportedBrowser.notRecommended": "我们十分抱歉，ClipCC 不支持您正在使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版本，例如 Chrome、Firefox、Edge 或者 Safari。",
    "gui.unsupportedBrowser.description": "我们十分抱歉，ClipCC并不支持您当前使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版，例如Chrome、Firefox、Edge或者Safari。",
    ...
    "gui.crashMessage.description": "很抱歉，ClipCC 出故障了。这个问题已经自动报告给别针团队。请刷新页面再试试。",
    ...
    "gui.webglModal.description": "非常遗憾，你的电脑或浏览器{webGlLink}。ClipCC 3.0需要该技术才能运行。",
    ...
    "gui.gui.defaultProjectTitle": "ClipCC 作品",
    ...
    "gui.menuBar.downloadToComputer.cc3": "存储 .cc3 文件到你的电脑",
  ...
  "zh-tw": {
    ...
    "gui.aboutModal.licenseContent": "GNU Affero 通用公共許可證第三版",
    ...
    "gui.menuBar.downloadToComputer.cc3": "保存.cc3文件到您的計算機",
    ...
    "gui.library.fromOnline": "從ClipCC在線擴展庫添加",
    "gui.extensionLibrary.unsupportChannel": "您所使用的瀏覽器不支持BroadcastChannel，因此您無法使用ClipCC在線擴展站。",
