...
const SidekickLinkDeviceAdapter = require('./sidekick-link-device-adapter');
...
/**
 * Manage communication with a GDX-FOR peripheral over a Sidekick Link client socket.
 */
class GdxFor {
     ...
     */
    _onConnect () {
        const adapter = new SidekickLinkDeviceAdapter(this._ble, BLEUUID);
...
/**
 * Sidekick blocks to interact with a GDX-FOR peripheral.
 */
class SidekickGdxForBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new GdxFor(this.runtime, SidekickGdxForBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: SidekickGdxForBlocks.EXTENSION_ID,
            name: SidekickGdxForBlocks.EXTENSION_NAME,
...
module.exports = SidekickGdxForBlocks;
