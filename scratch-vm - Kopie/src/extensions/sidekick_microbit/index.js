...
/**
 * Sidekick blocks to interact with a MicroBit peripheral.
 */
class SidekickMicroBitBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroBit(this.runtime, SidekickMicroBitBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: SidekickMicroBitBlocks.EXTENSION_ID,
            name: SidekickMicroBitBlocks.EXTENSION_NAME,
    ...
    _isTilted (direction) {
        ...
        case MicroBitTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX / 10) >= SidekickMicroBitBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY / 10) >= SidekickMicroBitBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= SidekickMicroBitBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = SidekickMicroBitBlocks;
