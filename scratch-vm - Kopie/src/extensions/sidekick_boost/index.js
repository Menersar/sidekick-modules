...
class BoostMotor {
    ...
    constructor (parent, index) {
         ...
         * that will be called once Sidekick VM gets a notification from the Move Hub.
         * @type {Object}
         * @private
         */
 ...
 * // ???
 * // !!!
 * Sidekick blocks to interact with a LEGO Boost peripheral.
 */
class SidekickBoostBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new Boost(this.runtime, SidekickBoostBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: SidekickBoostBlocks.EXTENSION_ID,
            name: 'BOOST',
    ...
    _isTilted (direction) {
        ...
        case BoostTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX) >= SidekickBoostBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY) >= SidekickBoostBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= SidekickBoostBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = SidekickBoostBlocks;
