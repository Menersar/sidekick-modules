...
class WeDo2 {
    ...
    constructor (runtime, extensionId) {
        ...
        /**
         * The Sidekick runtime used to trigger the green flag button.
         * @type {Runtime}
         * @private
         */
         ...
         * over the socket to Sidekick Link to a maximum number of sends per second.
         * @type {RateLimiter}
         * @private
         */
...
/**
 * Sidekick blocks to interact with a LEGO WeDo 2.0 peripheral.
 */
class SidekickWeDo2Blocks {
     ...
     * @param {Runtime} runtime - the Sidekick runtime.
     */
    constructor (runtime) {
        /**
         * The Sidekick runtime.
         * @type {Runtime}
         */
        this.runtime = runtime;

        // Create a new WeDo 2.0 peripheral instance
        this._peripheral = new WeDo2(this.runtime, SidekickWeDo2Blocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: SidekickWeDo2Blocks.EXTENSION_ID,
            name: 'WeDo 2.0',
    ...
    _isTilted (direction) {
        ...
        case WeDo2TiltDirection.ANY:
            return this._getTiltAngle(WeDo2TiltDirection.UP) >= SidekickWeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.DOWN) >= SidekickWeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.LEFT) >= SidekickWeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.RIGHT) >= SidekickWeDo2Blocks.TILT_THRESHOLD;
        default:
            return this._getTiltAngle(direction) >= SidekickWeDo2Blocks.TILT_THRESHOLD;
        }
    }
...
module.exports = SidekickWeDo2Blocks;
