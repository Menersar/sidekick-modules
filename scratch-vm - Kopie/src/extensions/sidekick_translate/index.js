...
/**
 * Class for the translate block in Sidekick.
 * @constructor
 */
class SidekickTranslateBlocks {
    constructor () {
        /**
    ...
    getViewerLanguage () {
        ...
        // code instead of Sidekick's (e.g. for es-419 we look up es to get espanol)
        if (!langNameObj && languageNames.sidekickToGoogleMap[this._viewerLanguageCode]) {
            const lookupCode = languageNames.sidekickToGoogleMap[this._viewerLanguageCode];
    ...
    getLanguageCodeFromArg (arg) {
        ...
        // ???
        // !!!
        // There are some languages we launched in the language menu that Sidekick did not
...
module.exports = SidekickTranslateBlocks;
