/**
 * @fileoverview
 * // ??? how and where to use ist ???
 * // !!!
 * A way to profile Sidekick internal performance. Like what blocks run during a
...
class Profiler {
    ...
    constructor (onFrame = function () {}) {
         ...
         * for Sidekick these frames are separated by block function opcode.
