...
class VirtualMachine extends EventEmitter {
    ...
    /**
     * Load a Sidekick project from a .sb, .sb2, .sb3, .sk or json string.
    ...
    /**
     * @returns {string} Project in a Sidekick JSON representation.
     */
    saveProjectSb3 () {
        ...
        return zip.generateAsync({
            type: 'blob',
            mimeType: 'application/x.sidekick.sb3',
            compression: 'DEFLATE',
            compressionOptions: {
    ...
    saveProjectSk (options, extensionCallback) {
        ...
        return zip.generateAsync({
            type: 'blob',
            mimeType: 'application/x.sidekick.sk',
            compression: 'DEFLATE',
            compressionOptions: {
                // !!!
                level: this.compressionLevel // Tradeoff between best speed (1) and best compression (9)
    ...
    exportSprite (targetId, optZipType) {
        ...
        return zip.generateAsync({
            ...
            mimeType: 'application/x.sidekick.sprite3',
            compression: 'DEFLATE',
            compressionOptions: {
                level: 6
            }
    ...
    /**
     * Export project or sprite as a Sidekick JSON representation.
    ...
    // a breaking change.
    /**
     * Load a project from a Sidekick JSON representation.
    ...
    deserializeProject (projectJSON, zip) {
        ...
        if (typeof performance !== 'undefined') {
            ...
            // !!! TESTEN
            // !!!
            performance.mark('sidekick-vm-deserialize-start');
        }
        const runtime = this.runtime;
        const deserializePromise = function () {
            // ???
            // !!!
            if (projectJSON.meta && projectJSON.meta.editor === 'sidekick') {
                const sk = require('./serialization/sk');
            ...
            return Promise.reject('Unable to verify Sidekick Project version.');
        };
    ...
    installTargets (targets, extensions, wholeProject) {
        ...
        // See: sidekick-gui/src/lib/sb-file-uploader-hoc.jsx
    ...
    /**
     * Emit an Blockly/sidekick-blocks compatible XML representation
     * // ???
     ...
     * // ???
     * // !!!
     * Allow VM consumer to configure the SidekickLink socket creator.
     * @param {Function} factory The custom SidekickLink socket factory.
     */
    configureSidekickLinkSocketFactory (factory) {
        this.runtime.configureSidekickLinkSocketFactory(factory);
    }
