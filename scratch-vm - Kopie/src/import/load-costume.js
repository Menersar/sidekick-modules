 ...
 * If the costume has bitmapResolution 1, it will be converted to bitmapResolution 2 here (the standard for Sidekick)
 ...
 * @param {!object} costume - the Sidekick costume object.
 * @param {!Runtime} runtime - Sidekick runtime, used to access the v2BitmapAdapter
 ...
 * @param {!Runtime} runtime - Sidekick runtime, used to access the storage module.
 * @param {?int} optVersion - Version of Sidekick that the costume comes from. If this is set
 *     to 2, Sidekick will perform an upgrade step to handle quirks in SVGs from Scratch 2.0.
