...
/**
 * @typedef {object} ConvertedBlockInfo - Raw extension block data paired with processed data ready for sidekick-blocks
 * @property {ExtensionBlockMetadata} info - the raw block info
 * @property {object} json - the sidekick-blocks JSON definition for this block
 * @property {string} xml - the sidekick-blocks XML definition for this block
 */
...
class ExtensionManager {
    ...
    _prepareMenuInfo (serviceName, menus) {
        ...
        for (let i = 0; i < menuNames.length; i++) {
            ...
            if (typeof menuInfo.items === 'string') {
                ...
                // Bind the function here so we can pass a simple item generation function to Sidekick Blocks later.
     ...
     * @returns {Array} menu items ready for sidekick-blocks.
     * @private
     */
