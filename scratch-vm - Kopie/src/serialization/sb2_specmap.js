 ...
 * // !!!
 * // !!!
 * @property {string} opcode - the Sidekick block opcode. Use 'extensionID.opcode' for extension opcodes.
 ...
 * @property {string} inputOp - the sidekick-blocks shadow type for this arg
 * @property {string} inputName - the name this argument will take when provided to the block implementation
 */

/**
 * Mapping of Scratch 2.0 opcode to Sidekick block metadata.
 ...
 * @param {SB2SpecMap_blockInfo} blockInfo - the Sidekick block info
 */
