...
class RenderedTarget extends Target {
    ...
    constructor (sprite, runtime) {
        ...
        /**
         * Whether this rendered target represents the Sidekick stage.
         * @type {boolean}
         */
        this.isStage = false;

        /**
         * Sidekick X coordinate. Currently should range from -240 to 240.
         * @type {Number}
         */
        this.x = 0;

        /**
         * Sidekick Y coordinate. Currently should range from -180 to 180.
         * @type {number}
         */
        this.y = 0;

        /**
         * Sidekick direction. Currently should range from -179 to 180.
         * @type {number}
         */
        this.direction = 90;
     ...
     * @param {!number} x New X coordinate, in Sidekick coordinates.
     * @param {!number} y New Y coordinate, in Sidekick coordinates.
    ...
    setSize (size) {
        ...
        if (this.renderer) {
            // ??? "original ScratchSprite.as:setSize" ???
            // !!!
     ...
     * Includes top, left, bottom, right attributes in Sidekick coordinates.
    ...
    isTouchingSprite (spriteName) {
        ...
        // ??? ueberhaupt gut, es nicht zu nutzen, nur wegen eventuell Kompatiblität (?) ???
        // !!!
