...
class SidekickSensingBlocks {
  ...
  getPrimitives() {
    return {
      ...
      sensing_sidekick_version: this.getVersion,
  ...
  getMonitored() {
    return {
      ...
      sensing_current: {
        ...
        // something that is not currently supported in sidekick.
  ...
  distanceTo(args, util) {
    ...
    if (args.DISTANCETOMENU === "_mouse_") {
      targetX = util.ioQuery("mouse", "getSidekickX");
      targetY = util.ioQuery("mouse", "getSidekickY");
    } else {
  ...
  getMouseX(args, util) {
    return util.ioQuery("mouse", "getSidekickX");
  }

  getMouseY(args, util) {
    return util.ioQuery("mouse", "getSidekickY");
  }
  ...
  getMousePressed(args, util) {
    return util.ioQuery("mouse", "getMousePressed", [
      Number(args.MOUSE_OPTION),
    ]);
  }
...
module.exports = SidekickSensingBlocks;
