 ...
 * // ???
 * // !!!
 * Enum for Ev3 device labels used in the Sidekick blocks/UI.
 * @readonly
 * @enum {string}
 */
const Ev3Label = {
...
class SidekickEv3Blocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new EV3(this.runtime, SidekickEv3Blocks.EXTENSION_ID);
    ...
    getInfo () {
        return {
            id: SidekickEv3Blocks.EXTENSION_ID,
            name: 'LEGO EV3',
...
module.exports = SidekickEv3Blocks;
