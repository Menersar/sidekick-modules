...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/extensions/sidekick_video_sensing/debug.js-exposed");
/******/ })
/************************************************************************/
/******/ ({
...
const VideoMotion = __webpack_require__(/*! ./library */ "./src/extensions/sidekick_video_sensing/library.js");
const VideoMotionView = __webpack_require__(/*! ./view */ "./src/extensions/sidekick_video_sensing/view.js");
...
/***/ "./src/extensions/sidekick_video_sensing/debug.js-exposed":
/*!****************************************************************!*\
  !*** ./src/extensions/sidekick_video_sensing/debug.js-exposed ***!
  \****************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["SidekickVideoSensingDebug"] = __webpack_require__(/*! -!./debug.js */ "./src/extensions/sidekick_video_sensing/debug.js");
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../node_modules/webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "./src/extensions/sidekick_video_sensing/library.js":
/*!**********************************************************!*\
  !*** ./src/extensions/sidekick_video_sensing/library.js ***!
  \**********************************************************/
/*! no static exports found */
...
var _require = __webpack_require__(/*! ./math */ "./src/extensions/sidekick_video_sensing/math.js"),
  motionVector = _require.motionVector,
  sidekickAtan2 = _require.sidekickAtan2;
  ...
  _createClass(VideoMotion, [{
    ...
    value: function analyzeFrame() {
      ...
      if (this.motionAmount > THRESHOLD) {
        // Sidekick direction
        this.motionDirection = sidekickAtan2(vv, uu);
      }
    }
    ...
    value: function getLocalMotion(drawable, state) {
      ...
      if (state.motionFrameNumber !== this.frameNumber) {
        ...
        // Transform the bounding box from sidekick space to a space from 0,
        // 0 to WIDTH, HEIGHT.
        ...
        for (var i = ymin; i < ymax; i++) {
          for (var j = xmin; j < xmax; j++) {
            ...
            // HEIGHT and 0 to WIDTH. Transform that into Sidekick's
        ...
        if (state.motionAmount > LOCAL_THRESHOLD) {
          // Sidekick direction.
          state.motionDirection = sidekickAtan2(v, u);
        }
...
/***/ "./src/extensions/sidekick_video_sensing/math.js":
/*!*******************************************************!*\
  !*** ./src/extensions/sidekick_video_sensing/math.js ***!
  \*******************************************************/
/*! no static exports found */
 ...
 * Sidekick's reference angle.
 * @param {number} degrees - angle in range -180 to 180
 * @returns {number} angle from Sidekick's reference angle
 */
var sidekickDegrees = function sidekickDegrees(degrees) {
  return (degrees + 270) % 360 - 180;
};

/**
 * Get the angle of the y and x component of a 2d vector in degrees in
 * Sidekick's coordinate plane.
 * @param {number} y - the y component of a 2d vector
 * @param {number} x - the x component of a 2d vector
 * @returns {number} angle in degrees in Sidekick's coordinate plane
 */
var sidekickAtan2 = function sidekickAtan2(y, x) {
  return sidekickDegrees(Math.atan2(y, x) * TO_DEGREE);
};
module.exports = {
  motionVector: motionVector,
  sidekickDegrees: sidekickDegrees,
  sidekickAtan2: sidekickAtan2
};

/***/ }),

/***/ "./src/extensions/sidekick_video_sensing/view.js":
/*!*******************************************************!*\
  !*** ./src/extensions/sidekick_video_sensing/view.js ***!
  \*******************************************************/
/*! no static exports found */
