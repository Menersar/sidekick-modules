...
const SET = 'sidekick-paint/clipboard/SET';
const INCREMENT_PASTE_OFFSET = 'sidekick-paint/clipboard/INCREMENT_PASTE_OFFSET';
const CLEAR_PASTE_OFFSET = 'sidekick-paint/clipboard/CLEAR_PASTE_OFFSET';
const initialState = {
    items: [],
    pasteOffset: 0
};
