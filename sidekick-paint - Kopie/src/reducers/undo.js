...
const UNDO = 'sidekick-paint/undo/UNDO';
const REDO = 'sidekick-paint/undo/REDO';
const SNAPSHOT = 'sidekick-paint/undo/SNAPSHOT';
const CLEAR = 'sidekick-paint/undo/CLEAR';
