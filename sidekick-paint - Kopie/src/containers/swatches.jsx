...
const mapStateToProps = state => ({
    ...
    fillColorIndex: state.sidekickPaint.color.fillColor.activeIndex,
    ...
    strokeColor: state.sidekickPaint.color.strokeColor.primary,
    strokeColor2: state.sidekickPaint.color.strokeColor.secondary,
    strokeColorIndex: state.sidekickPaint.color.strokeColor.activeIndex
});
