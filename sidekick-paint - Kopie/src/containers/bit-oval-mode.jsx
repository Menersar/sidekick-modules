...
const mapStateToProps = state => ({
    color: state.sidekickPaint.color.fillColor,
    filled: state.sidekickPaint.fillBitmapShapes,
    isOvalModeActive: state.sidekickPaint.mode === Modes.BIT_OVAL,
    selectedItems: state.sidekickPaint.selectedItems,
    thickness: state.sidekickPaint.bitBrushSize,
    zoom: state.sidekickPaint.viewBounds.scaling.x
});
