...
const mapStateToProps = state => ({
    fillModeGradientType: state.sidekickPaint.fillMode.gradientType, // Last user-selected gradient type
    fillColor: state.sidekickPaint.color.fillColor.primary,
    fillColor2: state.sidekickPaint.color.fillColor.secondary,
    fillStyleGradientType: state.sidekickPaint.color.fillColor.gradientType, // Selected item(s)' gradient type
    hoveredItemId: state.sidekickPaint.hoveredItemId,
    isFillModeActive: state.sidekickPaint.mode === Modes.FILL
});
