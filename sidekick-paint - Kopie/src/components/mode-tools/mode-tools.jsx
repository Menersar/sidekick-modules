...
const mapStateToProps = state => ({
    ...
    bitBrushSize: state.sidekickPaint.bitBrushSize,
    bitEraserSize: state.sidekickPaint.bitEraserSize,
    brushValue: state.sidekickPaint.brushMode.brushSize,
    clipboardItems: state.sidekickPaint.clipboard.items,
    eraserValue: state.sidekickPaint.eraserMode.brushSize
});
